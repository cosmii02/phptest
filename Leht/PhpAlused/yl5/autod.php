...
"1N6AA0EDXFN868772", "WBADW3C59DJ422810");
	...
	echo count($margid)." autot on nimekirjas <br>";
	
	echo (count($margid) == count($koodid)).", bool '1' niiet massiivid on sama pikad...<br>";
	...
	echo "listis oli ".$Toyota." Toyotat ja ".$Audi." Audit<br>";
